 ...
 */
export const distanceBetweenPoints = (point1: IMousePosition, point2: IMousePosition) => {
 ...
 */
export const angleBetweenPoints = (point1: IMousePosition, point2: IMousePosition) => {
